...
public class EngineerController {
    ...
    @PostMapping("/save")
    public String saveEngineer(@ModelAttribute Engineer emp) {
        engineerService.saveEngineer(emp);
    ...
    public String saveEngineer(@PathVariable Long id, @ModelAttribute Engineer emp) {
           emp.setId(id);
           engineerService.saveEngineer(emp);
           return "redirect:/users/list"; 
        }
